...
namespace api.Repository
{
    public class StockRepository : IStockRepository
    {
        ...
        public async Task<List<Stock>> GetAllAsync(QueryObject query)
        {
            ...
            {
                if(query.SortBy.Equals("Symbol", StringComparison.OrdinalIgnoreCase))// sort by symbol if SortBy is "Symbol"
                {
        ...
        {
            return _context.Stocks.AnyAsync(s => s.Id == id); // returns true if stock with given id exists, false otherwise
        }
